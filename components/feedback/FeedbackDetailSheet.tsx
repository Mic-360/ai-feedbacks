...
export function FeedbackDetailSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="!max-w-none w-full sm:w-[95vw] md:w-[90vw] lg:w-[85vw] xl:w-[1280px] sm:!max-w-[1280px] overflow-hidden bg-[var(--paper)] text-[var(--ink)] border-l border-[var(--rule-strong)] !rounded-none p-0"
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          {error && (
            <p className="marker text-xs px-6 py-3" role="alert">
              {error}
            </p>
          )}
